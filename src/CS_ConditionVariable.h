...
char cscvm_create(CS_ConditionVariableMutex* mutex);
char cscvm_lock(CS_ConditionVariableMutex* mutex);
char cscvm_unlock(CS_ConditionVariableMutex* mutex);
char cscvm_destroy(CS_ConditionVariableMutex* mutex);

inline char cscvm_create(CS_ConditionVariableMutex* mutex)
{
#if defined(C11_THREADS) || defined(POSIX_THREADS)
...
inline char cscvm_lock(CS_ConditionVariableMutex* mutex)
{
#if defined(C11_THREADS) || defined(POSIX_THREADS)
...
inline char cscvm_unlock(CS_ConditionVariableMutex* mutex)
{
#if defined(C11_THREADS) || defined(POSIX_THREADS)
...
inline char cscvm_destroy(CS_ConditionVariableMutex* mutex)
{
#if defined(C11_THREADS) || defined(POSIX_THREADS)
